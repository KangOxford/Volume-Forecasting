...
df = pd.read_csv(data_path+date+'/'+date + '-'+ sym+'.csv').iloc[:,3:].drop(['volBuyQty_lit',
       'volBuyNotional_lit', 'volBuyNrTrades_lit', 'volSellQty_lit',
       'volSellNotional_lit', 'volSellNrTrades_lit', 'volBuyQty_hid',
       'volBuyNotional_hid', 'volBuyNrTrades_hid', 'volSellQty_hid',
       'volSellNotional_hid', 'volSellNrTrades_hid', 'jump_value', 'is_jump',
       'signed_jump'],axis =1)
